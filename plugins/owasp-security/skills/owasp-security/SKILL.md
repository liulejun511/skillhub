...
status: active
origin: installed
author: agamm (agamm/claude-code-owasp)
license: MIT
upstream: https://github.com/agamm/claude-code-owasp/tree/main/.claude/skills/owasp-security
upstream_sha: 37bd78593493f46c3fbf5286a9b30dd75411551d
tags:
- security
- owasp
- code-review
description: Use when reviewing code for security vulnerabilities, implementing authentication/authorization,
  handling user input, or discussing web application security. Covers OWASP Top 10:2025,
  ASVS 5.0, LLM Top 10 (2025), and Agentic AI security (2026).
